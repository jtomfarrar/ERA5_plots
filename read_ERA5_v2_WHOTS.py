...
lcc_params={'projection':'lcc', 'lat_1':20.,'lat_2':30,'lat_0':lat_pt,'lon_0':lon_pt,'width':10*10**6,'height':7*10**6, 'resolution':'i'}
...
# map = Basemap(projection='lcc', lat_1=20.,lat_2=55,lat_0=60,lon_0=0,width=7*10**6,height=5*10**6, resolution = 'i')
